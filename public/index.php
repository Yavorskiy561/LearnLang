...
$current_uri = isset($_SERVER['REQUEST_URI']) ? parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) : '';
    ...
    <div class="wrapper flex-grow-1">
        ...
        <main class="content_page">
                    ...
                    <div class="row">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <img src="/resourse/1kbx.gif" class="justify-content-center m-auto" width="600" alt="LearnLang presentation">
                            </div>
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-xs-12">
                            <div class="p-1 d-flex justify-content-center mb-4 itd-bg-p">
                                ...
                                <img src="/resourse/15378168_5602758 1.svg" class="ms-4" alt="Карьерные возможности" height="200">
                            </div>
                        </div>
                        <div class="col-xs-12">
            ...
            <?php foreach ($languages as $lang): 
                ...
                $lang_name = htmlspecialchars($lang['name'] ?? '');
                $lang_description = htmlspecialchars($lang['description'] ?? '');
                    ...
                    <div class="container">
                        <div class="row mb-4 itd-row">
                            <div class="col-md-6 col-sm-12 itd-bg">
                                <img src="/resourse/<?= ucfirst($lang_name) ?>.svg" width="150" class="d-block mx-auto rounded mb-4" alt="Язык программирования <?= $lang_name ?>">
                                <p class="<?= $text_class ?> mb-5"><?= $lang_description ?></p>
